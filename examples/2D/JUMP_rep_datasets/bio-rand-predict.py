...
def setup_paths(test_data_path=None):
    ...
    if test_data_path is None:
        ...
        dataset_dir = "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_datasets/bio-rand-1/5_channels/dna_rna_er_agp_mito"
    else:
        dataset_dir = test_data_path
    
    paths = {
        'dataset_dir': dataset_dir,
        'noise_model_path': "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_datasets/bio-rand-1-noise_models",
        'checkpoint_path': "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_datasets/checkpoints/bio-rand-1-v2/best-epoch=28.ckpt"
    }
    return paths
...
def main():
    ...
    save_dir = f"bio-rand_predictions_v2"
