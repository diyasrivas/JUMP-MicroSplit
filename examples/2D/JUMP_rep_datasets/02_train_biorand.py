...
def main():
    ...
    NOISE_MODELS_DIR = "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_datasets/bio-rand-1-noise_models"
    ...
    checkpoint_dir = f"./checkpoints/bio-rand-1-v2"
