...
def setup_paths(test_data_path=None):
    ...
    if test_data_path is None:
        ...
        dataset_dir = "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_ORF/test_data"
    else:
        dataset_dir = test_data_path
    
    paths = {
        'dataset_dir': dataset_dir,
        'noise_model_path': "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_ORF/noise_models_rand1_orf_rand2_100images",
        'checkpoint_path': "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_ORF/checkpoints/rand-2/best-epoch=43.ckpt"
    }
    return paths
...
def main():
    ...
    parser.add_argument('--test-data', type=str, 
                       default="/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP_rep_ORF/test_data",
    ...
    save_dir = f"orf_predictions_rand2"
