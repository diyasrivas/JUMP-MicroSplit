#!/usr/bin/env python3
"""
MicroSplit training for cpg0029-chroma-pilot Cell Painting dataset.
...
Usage:
    python 3_train.py --dataset_dir /project/cell_paint_mono/training_datasets/training_dataset_cpg0029
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="MicroSplit training for cpg0029-chroma-pilot"
    )
