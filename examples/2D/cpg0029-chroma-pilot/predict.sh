#!/bin/bash
# MicroSplit plate-level prediction for cpg0029-chroma-pilot (Step 4).
#
# Submits one SLURM job per plate.
#
# Usage:
#   ./predict.sh --plate_dir /path/to/plate
#   ./predict.sh --batch 2023_05_15_Batch1 --slurm
#   ./predict.sh --batch 2023_05_15_Batch1 --slurm --dependency "TRAIN_JOB_ID"
#
# Options:
#   --batch NAME             Batch name for plate discovery (e.g. 2023_05_15_Batch1)
#   --plate_dir DIR          Process a single plate directory
#   --data_dir DIR           Root data dir (default: /project/cell_paint_mono/cpg0029-chroma-pilot/images)
#   --training_dir DIR       Training dataset dir (default: /project/cell_paint_mono/training_datasets/training_dataset_cpg0029)
#   --output_dir DIR         Output root (default: /project/cell_paint_mono/predictions/cpg0029-chroma-pilot)
...
TRAINING_DIR="/project/cell_paint_mono/training_datasets/training_dataset_cpg0029"
OUTPUT_DIR="/project/cell_paint_mono/predictions/cpg0029-chroma-pilot"
MMSE_COUNT=50
NUM_POSTERIOR=3
GRID_SIZE=32
MAX_FOVS=0
...
echo "================================================================================" >&2
echo "cpg0029 predict | plates=${#PLATE_DIRS[@]}" >&2
...
#!/bin/bash
#SBATCH --job-name=pred_cpg0029_${PNAME:0:20}
...
echo "Job \${SLURM_JOB_ID}: predict cpg0029 ${PNAME} | Node: \${SLURMD_NODENAME} | Start: \$(date)"
