#!/usr/bin/env python3
"""
MicroSplit plate-level prediction for cpg0029-chroma-pilot Cell Painting data.
...
Channel mapping (cpg0029-chroma-pilot, 8-ch Opera Phenix):
...
Usage:
    python 4_predict.py \\
        --plate_dir  /project/cell_paint_mono/cpg0029-chroma-pilot/images/{batch}/{plate}/ \\
...
# cpg0029-chroma-pilot channel mapping (8-channel Opera Phenix)
CHANNEL_MAPPING = {"DNA": 7, "RNA": 3, "ER": 4, "AGP": 5, "Mito": 6}

# Dye condition lookup by plate barcode
DYE_CONDITION_MAP = {
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="MicroSplit plate prediction for cpg0029-chroma-pilot"
    )
...
def main():
    ...
    dye_condition = DYE_CONDITION_MAP.get(plate_barcode, "unknown")
    ...
    print(f"Dye condition: {dye_condition}")
