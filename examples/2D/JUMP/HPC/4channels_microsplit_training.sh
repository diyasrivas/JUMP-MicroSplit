...
#SBATCH --job-name=microsplit_4channels
...
# Define all 4-channel combinations
COMBINATIONS=(
  "DNA, ER, AGP, Mito"
  "DNA, RNA, ER, AGP"
  "RNA, ER, AGP, Mito"
...
DATASET_DIR="experiments/4_channels/${DIR_NAME}"
OUTPUT_DIR="training_results/4_channels/${DIR_NAME}"
