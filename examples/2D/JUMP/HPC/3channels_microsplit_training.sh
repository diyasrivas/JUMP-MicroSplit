...
#SBATCH --job-name=microsplit_3channels
...
# Define all 3-channel combinations
COMBINATIONS=(
  "DNA, AGP, Mito"
  "DNA, RNA, AGP"
  "ER, AGP, Mito"
...
DATASET_DIR="experiments/3_channels/${DIR_NAME}"
OUTPUT_DIR="training_results/3_channels/${DIR_NAME}"
