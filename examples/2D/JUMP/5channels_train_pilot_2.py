...
def main():
    ...
    NOISE_MODELS_DIR = "/home/diya.srivastava/Desktop/repos/JUMP-MicroSplit/examples/2D/JUMP/pilot_dataset_notebooks/noise_models_pilot"
    ...
    checkpoint_dir = f"./checkpoints/pilot_2_{num_channels}_channels"
