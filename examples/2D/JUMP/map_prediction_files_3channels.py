...
original_dir = f"{base_dir}/experiments/3_channels/dna_rna_agp"
predictions_dir = f"{base_dir}/notebooks/3channels_predictions_DNA_RNA_AGP"
output_dir = f"{base_dir}/notebooks/cellprofiler_input/dna_rna_agp"
