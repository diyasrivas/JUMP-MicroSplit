#!/usr/bin/env python3
"""
MicroSplit training for cpg0036-EU-OS-bioactives Cell Painting dataset.

Train one model per cell line (HepG2 or U2OS). Point --dataset_dir at the
directory built by 1_datasets.py for the target cell line.

Dataset channels (4 total):
  DNA, ER_RNA, Actin_AGP, Mito

Expected dataset layout under <dataset_dir>/:
    DNA/ ER_RNA/ Actin_AGP/ Mito/  — individual channel .tiff files (uint16)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="MicroSplit training for cpg0036-EU-OS-bioactives"
    )
