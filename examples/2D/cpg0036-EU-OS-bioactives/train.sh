#!/bin/bash
# MicroSplit training for cpg0036-EU-OS-bioactives (Step 3).
#
# Run once per cell line. Point --dataset_dir at the correct cell-line directory.
#
# Usage:
#   ./train.sh --dataset_dir .../training_dataset_cpg0036_HepG2
#   ./train.sh --dataset_dir .../training_dataset_cpg0036_U2OS --test
#   ./train.sh --dataset_dir ... --dependency "NM_JOB1:NM_JOB2:NM_JOB3:NM_JOB4"
#
# Options:
#   --dataset_dir DIR            Training dataset directory (required)
...
# Extract cell-line label from dataset dir name for job naming
CELL_LABEL=$(basename "${DATASET_DIR}" | sed 's/training_dataset_cpg0036_//')

echo "================================================================================" >&2
echo "${MODE_NAME}: cpg0036 ${CELL_LABEL} | epochs=${NUM_EPOCHS} batch=${BATCH_SIZE}" >&2
...
#!/bin/bash
#SBATCH --job-name=${MODE_NAME}_cpg0036_${CELL_LABEL}
#SBATCH --output=${LOG_DIR}/${MODE_NAME,,}_cpg0036_${CELL_LABEL}_%j.log
#SBATCH --error=${LOG_DIR}/${MODE_NAME,,}_cpg0036_${CELL_LABEL}_%j.log
...
echo "Job \${SLURM_JOB_ID}: ${MODE_NAME} train cpg0036 ${CELL_LABEL} | Node: \${SLURMD_NODENAME} | Start: \$(date)"
...
echo "Submitted job ${JOB_ID}: ${MODE_NAME} train cpg0036 ${CELL_LABEL}" >&2
echo "${JOB_ID}"
